  ...
  setup(__props) {
    ...
    const login = () => {
      myForm.value.validate(() => {
        http_index.postRequest("api/mobile/elogin", loginModel).then((res) => {
          if (res.success) {
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-fa14255b"], ["__file", "C:/Users/24673/Desktop/新建文件夹 (8)/H5考试材料/uniapp-vue3-wx/pages/index/login.vue"]]);
